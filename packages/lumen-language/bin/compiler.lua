...
local function literal(s)
  if string_literal63(s) then
    ...
    if string63(s) and numeric63(s) then
...
setenv("arguments%", {_stash = true, macro = function ()
  local ____x11 = {"target"}
  ____x11.js = "*args"
  ____x11.lua = {"list", "|...|"}
  return ____x11
end})
setenv("args%", {_stash = true, macro = function ()
  local ____x15 = {"target"}
  ____x15.js = {"%literal", "|...|", "*args"}
  ____x15.lua = "|...|"
  return ____x15
end})
function bind42(args, body)
  ...
  local function rest()
    __args1.rest = true
    return {"unstash", {"arguments%"}}
  end
  local function kwrest()
    __args1.rest = true
    return {"destash", {"arguments%"}}
  end
  local function arest()
    __args1.rest = true
    return {{"*args", "**kwargs"}}
  end
  local __bs1 = {}
  ...
  if keys63(args) then
    ...
    __bs1 = join(__bs1, {"**kwargs", kwrest()})
    local __ks = keys(args)
    __ks.rest = nil
    __bs1 = join(__bs1, {__ks, "**kwargs"})
    ...
    __bs1 = join(__bs1, {keys(args), __r23})
  end
...
local function expand_local(__x34)
  local ____id1 = __x34
  local __x35 = ____id1[1]
  local __name = ____id1[2]
  local __value = ____id1[3]
  setenv(__name, {_stash = true, variable = true})
  return {"%local", __name, macroexpand(__value)}
end
local function expand_function(__x37)
  local ____id2 = __x37
  local __x38 = ____id2[1]
  ...
  for ____i5 in next, ____o3 do
    local ____x39 = ____o3[____i5]
    setenv(____x39, {_stash = true, variable = true})
  end
  local ____x40 = join({"%function", __args}, macroexpand(__body))
  drop(environment)
  return ____x40
end
local function expand_definition(__x42)
  local ____id3 = __x42
  ...
  for ____i6 in next, ____o4 do
    local ____x44 = ____o4[____i6]
    setenv(____x44, {_stash = true, variable = true})
  end
  local ____x45 = join({__x43, __name1, __args11}, macroexpand(__body1))
  drop(environment)
  return ____x45
end
...
local function quasiquote_list(form, depth)
  ...
  local ____x51 = form
  local ____i8 = 0
  while ____i8 < _35(____x51) do
    local __x52 = ____x51[____i8 + 1]
    if quasisplice63(__x52, depth) then
      local __x53 = quasiexpand(__x52[2])
      add(__xs, __x53)
      add(__xs, {"list"})
    else
...
function unique(x)
  local __x61 = id(x)
  if has63(__names, __x61) then
    local __i11 = __names[__x61]
    __names[__x61] = __names[__x61] + 1
    return unique(__x61 .. __i11)
  else
    __names[__x61] = 1
    return "__" .. __x61
  end
...
function key(k)
  if string_literal63(k) then
    ...
    local __k5 = compile(k)
    if number63(__k5) and target == "lua" then
      __k5 = __k5 + 1
    end
    return "[" .. __k5 .. "]"
  end
...
____x76.lua = "or"
____x75["or"] = ____x76
local infix = {____x64, ____x66, ____x67, ____x69, ____x70, ____x71, ____x73, ____x75}
...
local function compile_args(args)
  ...
  local ____x79 = args
  local ____i15 = 0
  while ____i15 < _35(____x79) do
    local __x80 = ____x79[____i15 + 1]
...
local function compile_special(form, stmt63)
  local ____id6 = form
  local __x81 = ____id6[1]
  local __args2 = cut(____id6, 1)
  local ____id7 = getenv(__x81)
...
local function compile_rest(args)
  if args.rest then
    local __e32 = nil
    if target == "lua" then
      __e32 = "|...|"
...
function compile_function(args, body, ...)
  ...
  local __prefix1 = ____id15.prefix
  local __e33 = nil
  if __name4 then
    __e33 = compile(__name4)
  else
    __e33 = ""
  end
  local __id16 = __e33
  local __args12 = compile_rest(__args4)
  local __args5 = compile_args(__args12)
  indent_level = indent_level + 1
  local ____x90 = compile(__body3, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __body4 = ____x90
...
function compile(form, ...)
  ...
  local ____id17 = ___4242kwargs2
  local __stmt1 = ____id17.stmt
  local __form = destash33(form, ____r66)
  local ____id18 = ____r66
  local __stmt2 = ____id18.stmt
  if nil63(__form) then
    return ""
  else
    if special_form63(__form) then
      return compile_special(__form, __stmt2)
    else
      local __tr2 = terminator(__stmt2)
      local __e36 = nil
      if __stmt2 then
        __e36 = indentation()
      else
...
local function lower_set(args, hoist, stmt63, tail63)
  local ____id19 = args
  local __lh = ____id19[1]
  local __rh = ____id19[2]
...
local function lower_short(x, args, hoist)
  ...
  if some63(__hoist1) then
    ...
    local __e44 = nil
    if x == "and" then
      __e44 = {"%if", __id22, __b4, __id22}
    else
      __e44 = {"%if", __id22, __id22, __b4}
    end
    return lower({"do", {"%local", __id22, __a3}, __e44}, hoist)
  else
...
local function lower_while(args, hoist)
  local ____id23 = args
  local __c4 = ____id23[1]
  local __body5 = cut(____id23, 1)
  local __pre = {}
...
local function lower_for(args, hoist)
  local ____id24 = args
  local __t = ____id24[1]
  local __k8 = ____id24[2]
  local __body6 = cut(____id24, 2)
  return add(hoist, {"%for", lower(__t, hoist), __k8, lower_body(__body6)})
end
local function lower_function(args)
  local ____id25 = args
  local __a4 = ____id25[1]
  local __body7 = cut(____id25, 1)
  return {"%function", __a4, lower_body(__body7, true)}
end
local function lower_definition(kind, args, hoist)
  local ____id26 = args
  local __name5 = ____id26[1]
  local __args6 = ____id26[2]
  local __body8 = cut(____id26, 2)
  return add(hoist, {kind, __name5, __args6, lower_body(__body8, true)})
end
...
local function lower_infix(form, hoist)
  ...
  local ____id28 = __form3
  local __x131 = ____id28[1]
  local __args8 = cut(____id28, 1)
    ...
    if empty63(form) then
      ...
      if nil63(hoist) then
        ...
        if lower_infix63(form) then
          ...
          local ____id29 = form
          local __x134 = ____id29[1]
          local __args9 = cut(____id29, 1)
          if __x134 == "do" then
...
setenv("do", {_stash = true, special = function (...)
  ...
  local ____id32 = ___4242kwargs4
  local ____id33 = ____r95
  local __forms1 = cut(____id33, 0)
  local __s3 = ""
...
setenv("%local", {_stash = true, special = function (name, value)
  ...
  return __ind11 .. __keyword1 .. __id35 .. __rh2
end, stmt = true})
...
setenv("%array", {_stash = true, special = function (...)
  ...
  local ____id38 = ___4242kwargs6
  local ____id39 = ____r129
  local __forms3 = cut(____id39, 0)
  local __e52 = nil
  if target == "lua" then
    __e52 = "{"
  else
...
setenv("%object", {_stash = true, special = function (...)
  ...
  local ____id43 = ___4242kwargs8
  local ____id44 = ____r131
  local __forms5 = cut(____id44, 0)
  local __s9 = "{"
  local __c9 = ""
  local __e54 = nil
  if target == "lua" then
  ...
  for __k15 in next, ____o12 do
    local __v12 = ____o12[__k15]
    if number63(__k15) then
      local ____id45 = __v12
      local __k16 = ____id45[1]
      local __v13 = ____id45[2]
      __s9 = __s9 .. __c9 .. key(__k16) .. __sep1 .. compile(__v13)
      __c9 = ", "
    end
  end
  return __s9 .. "}"
...
setenv("%literal", {_stash = true, special = function (...)
  ...
  local ____id48 = ___4242kwargs10
  local ____id49 = ____r133
  local __args111 = cut(____id49, 0)
