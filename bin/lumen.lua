...
setenv("let-place", {_stash = true, macro = function (vars, place, ...)
  ...
  local __vars1 = destash33(vars, ____r3)
  local __place2 = destash33(place, ____r3)
...
setenv("set", {_stash = true, macro = function (...)
  ...
  return join({"do"}, map(function (__x14)
    local ____id3 = __x14
    local __lh1 = ____id3[1]
    local __rh1 = ____id3[2]
...
setenv("list", {_stash = true, macro = function (...)
  ...
  for __k2 in next, ____o1 do
    ...
    if number63(__k2) then
      ...
      add(__forms1, {"set", {"get", __x34, {"quote", __k2}}, __v1})
    end
  end
  if some63(__forms1) then
    return join({"let", __x34, join({"%array"}, __l1)}, __forms1, {__x34})
  else
...
setenv("case", {_stash = true, macro = function (expr, ...)
  ...
  local __expr1 = destash33(expr, ____r17)
  local ____id6 = ____r17
  local __clauses1 = cut(____id6, 0)
  local __x57 = unique("x")
  local __eq1 = function (_)
    return {"=", {"quote", _}, __x57}
  end
  local __cl1 = function (__x60)
    local ____id7 = __x60
  ...
  return {"let", __x57, __expr1, join({"if"}, apply(join, map(__cl1, pair(__clauses1))))}
end})
setenv("when", {_stash = true, macro = function (cond, ...)
  local ____r21 = unstash({...})
  local __cond1 = destash33(cond, ____r21)
  local ____id9 = ____r21
  local __body5 = cut(____id9, 0)
  return {"if", __cond1, join({"do"}, __body5)}
end})
setenv("unless", {_stash = true, macro = function (cond, ...)
  local ____r23 = unstash({...})
  local __cond3 = destash33(cond, ____r23)
  local ____id11 = ____r23
  local __body7 = cut(____id11, 0)
  return {"if", {"not", __cond3}, join({"do"}, __body7)}
end})
...
setenv("let", {_stash = true, macro = function (bs, ...)
  ...
  local __bs11 = destash33(bs, ____r27)
  local ____id16 = ____r27
  ...
  if atom63(__bs11) then
    ...
    if none63(__bs11) then
      ...
      local ____id17 = __bs11
      local __lh3 = ____id17[1]
      local __rh3 = ____id17[2]
      local __bs21 = cut(____id17, 2)
      local ____id18 = bind(__lh3, __rh3)
      local __id19 = ____id18[1]
      local __val1 = ____id18[2]
      local __bs12 = cut(____id18, 2)
      local __id121 = unique(__id19)
      return {"do", {"%local", __id121, __val1}, {"let-symbol", {__id19, __id121}, join({"let", join(__bs12, __bs21)}, __body11)}}
    end
  end
end})
setenv("with", {_stash = true, macro = function (x, v, ...)
  ...
  local __v3 = destash33(v, ____r29)
  local ____id21 = ____r29
  local __body13 = cut(____id21, 0)
  return join({"let", {__x110, __v3}}, __body13, {__x110})
end})
setenv("let-when", {_stash = true, macro = function (x, v, ...)
  local ____r31 = unstash({...})
  local __x122 = destash33(x, ____r31)
  local __v5 = destash33(v, ____r31)
  local ____id23 = ____r31
  local __body15 = cut(____id23, 0)
  local __y1 = unique("y")
  return {"let", __y1, __v5, {"when", {"yes", __y1}, join({"let", {__x122, __y1}}, __body15)}}
end})
setenv("define-macro", {_stash = true, macro = function (name, args, ...)
  local ____r33 = unstash({...})
  local __name1 = destash33(name, ____r33)
  local __args3 = destash33(args, ____r33)
  local ____id25 = ____r33
  local __body17 = cut(____id25, 0)
  local ____x133 = {"setenv", {"quote", __name1}}
  ____x133.macro = join({"fn", __args3}, __body17)
  local __form1 = ____x133
  _eval(__form1)
  return __form1
end})
setenv("define-special", {_stash = true, macro = function (name, args, ...)
  local ____r35 = unstash({...})
  local __name3 = destash33(name, ____r35)
  local __args5 = destash33(args, ____r35)
  local ____id27 = ____r35
  local __body19 = cut(____id27, 0)
  local ____x141 = {"setenv", {"quote", __name3}}
  ____x141.special = join({"fn", __args5}, __body19)
  local __form3 = join(____x141, keys(__body19))
  _eval(__form3)
  return __form3
end})
setenv("define-symbol", {_stash = true, macro = function (name, expansion)
  setenv(name, {_stash = true, symbol = expansion})
  local ____x147 = {"setenv", {"quote", name}}
  ____x147.symbol = {"quote", expansion}
  return ____x147
end})
setenv("define-reader", {_stash = true, macro = function (__x156, ...)
  local ____id30 = __x156
  local __char1 = ____id30[1]
  local __s1 = ____id30[2]
  local ____r39 = unstash({...})
  local ____x156 = destash33(__x156, ____r39)
...
setenv("define", {_stash = true, macro = function (name, x, ...)
  ...
  local __name5 = destash33(name, ____r41)
  local __x167 = destash33(x, ____r41)
  local ____id33 = ____r41
  local __body23 = cut(____id33, 0)
  setenv(__name5, {_stash = true, variable = true})
  if some63(__body23) then
    return join({"%local-function", __name5}, bind42(__x167, __body23))
  else
    return {"%local", __name5, __x167}
  end
end})
setenv("define-global", {_stash = true, macro = function (name, x, ...)
  local ____r43 = unstash({...})
  local __name7 = destash33(name, ____r43)
  local __x175 = destash33(x, ____r43)
  local ____id35 = ____r43
  local __body25 = cut(____id35, 0)
  setenv(__name7, {_stash = true, toplevel = true, variable = true})
  if some63(__body25) then
    return join({"%global-function", __name7}, bind42(__x175, __body25))
  else
    return {"set", __name7, __x175}
  end
end})
setenv("with-frame", {_stash = true, macro = function (...)
  local __body27 = unstash({...})
  local __x187 = unique("x")
  return {"do", {"add", "environment", {"obj"}}, {"with", __x187, join({"do"}, __body27), {"drop", "environment"}}}
end})
setenv("with-bindings", {_stash = true, macro = function (__x200, ...)
  local ____id38 = __x200
  local __names1 = ____id38[1]
  local ____r45 = unstash({...})
  local ____x200 = destash33(__x200, ____r45)
  local ____id39 = ____r45
  local __body29 = cut(____id39, 0)
  local __x202 = unique("x")
  local ____x205 = {"setenv", __x202}
  ____x205.variable = true
  return join({"with-frame", {"each", __x202, __names1, ____x205}}, __body29)
end})
setenv("let-macro", {_stash = true, macro = function (definitions, ...)
  local ____r48 = unstash({...})
  local __definitions1 = destash33(definitions, ____r48)
  local ____id41 = ____r48
  local __body31 = cut(____id41, 0)
  add(environment, {})
  map(function (m)
    return macroexpand(join({"define-macro"}, m))
  end, __definitions1)
  local ____x211 = join({"do"}, macroexpand(__body31))
  drop(environment)
  return ____x211
end})
setenv("let-symbol", {_stash = true, macro = function (expansions, ...)
  local ____r52 = unstash({...})
  local __expansions1 = destash33(expansions, ____r52)
  local ____id44 = ____r52
  local __body33 = cut(____id44, 0)
  add(environment, {})
  map(function (__x221)
    local ____id45 = __x221
    local __name9 = ____id45[1]
    local __exp1 = ____id45[2]
    return macroexpand({"define-symbol", __name9, __exp1})
  end, pair(__expansions1))
  local ____x220 = join({"do"}, macroexpand(__body33))
  drop(environment)
  return ____x220
end})
setenv("let-unique", {_stash = true, macro = function (names, ...)
  local ____r56 = unstash({...})
  local __names3 = destash33(names, ____r56)
  local ____id47 = ____r56
...
setenv("apply", {_stash = true, macro = function (f, ...)
  ...
  local __f1 = destash33(f, ____r61)
  local ____id51 = ____r61
...
setenv("guard", {_stash = true, macro = function (expr)
  if target == "js" then
    ...
    local ____x282 = {"obj"}
    ____x282.stack = {{"get", "debug", {"quote", "traceback"}}}
    ____x282.message = {"if", {"string?", "m"}, {"clip", "m", {"+", {"or", {"search", "m", "\": \""}, -2}, 2}}, {"nil?", "m"}, "\"\"", {"str", "m"}}
    return {"list", {"xpcall", {"fn", join(), expr}, {"fn", {"m"}, {"if", {"obj?", "m"}, "m", ____x282}}}}
  end
end})
setenv("each", {_stash = true, macro = function (x, t, ...)
  local ____r65 = unstash({...})
  local __x310 = destash33(x, ____r65)
  local __t1 = destash33(t, ____r65)
  local ____id54 = ____r65
  local __body39 = cut(____id54, 0)
  local __o3 = unique("o")
  local __n3 = unique("n")
  local __i3 = unique("i")
  local __e7 = nil
  if atom63(__x310) then
    __e7 = {__i3, __x310}
  else
    local __e8 = nil
    if _35(__x310) > 1 then
      __e8 = __x310
    else
      __e8 = {__i3, hd(__x310)}
    end
...
setenv("for", {_stash = true, macro = function (i, to, ...)
  ...
  local __i5 = destash33(i, ____r67)
  local __to1 = destash33(to, ____r67)
...
setenv("step", {_stash = true, macro = function (v, t, ...)
  ...
  local __v9 = destash33(v, ____r69)
  local __t3 = destash33(t, ____r69)
  local ____id59 = ____r69
  local __body43 = cut(____id59, 0)
  local __x346 = unique("x")
  local __i7 = unique("i")
  return {"let", {__x346, __t3}, {"for", __i7, {"#", __x346}, join({"let", {__v9, {"at", __x346, __i7}}}, __body43)}}
end})
...
setenv("join!", {_stash = true, macro = function (a, ...)
  ...
  local __a3 = destash33(a, ____r73)
...
setenv("cat!", {_stash = true, macro = function (a, ...)
  ...
  local __a5 = destash33(a, ____r75)
  local ____id63 = ____r75
...
setenv("with-indent", {_stash = true, macro = function (form)
  local __x389 = unique("x")
  return {"do", {"inc", "indent-level"}, {"with", __x389, form, {"dec", "indent-level"}}}
end})
setenv("undefined?", {_stash = true, macro = function (x)
  local ____x398 = {"target"}
  ____x398.lua = {"=", x, "nil"}
  ____x398.js = {"=", {"typeof", x}, "\"undefined\""}
  return ____x398
end})
setenv("export", {_stash = true, macro = function (...)
  local __names5 = unstash({...})
  local ____x420 = {"target"}
  ____x420.lua = {"return", "exports"}
  return join({"with", "exports", {"if", {"undefined?", "exports"}, {"obj"}, "exports"}}, map(function (k)
    return {"set", {"exports", "." .. k}, k}
  end, __names5), {____x420})
end})
