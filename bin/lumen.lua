...
function _G.find(x, t)
  ...
  local ____o6 = t
  local ____i6 = nil
  for ____i6 in pairs(____o6) do
    local __x4 = ____o6[____i6]
    local __y = __f(__x4)
    if __y then
      return __y
    end
...
function _G.empty63(t)
  local ____o10 = t
  local ____i13 = nil
  for ____i13 in pairs(____o10) do
    local __x7 = ____o10[____i13]
    return false
  end
  return true
end
      ...
      if function63(x) then
        ...
        if stack and in63(x, stack) then
          ...
          if not( type(x) == "table") then
            ...
            local ____i24 = nil
            for ____i24 in pairs(____o15) do
              local __v14 = ____o15[____i24]
...
setenv("var", {_stash = true, macro = function (bs, ...)
...
setenv("let", {_stash = true, macro = function (bs, ...)
  ...
  local __bs11 = destash33(bs, ____r21)
  ...
  if atom63(__bs11) then
    ...
    if none63(__bs11) then
      ...
      if brackets63(__bs11) then
        local __e = nil
        if empty63(__body11) then
          __e = "var"
        else
          __e = "let"
        end
        ...
        local ____id13 = __bs11
        local __lh2 = ____id13[1]
        local __rh2 = ____id13[2]
        local __bs21 = cut(____id13, 2)
        local ____id14 = bind(__lh2, __rh2)
        local __id15 = ____id14[1]
        local __val1 = ____id14[2]
        local __bs12 = cut(____id14, 2)
        local __id111 = unique(__id15)
...
setenv("with", {_stash = true, macro = function (x, v, ...)
  ...
  local __x83 = destash33(x, ____r22)
  local __v2 = destash33(v, ____r22)
  local ____id16 = ____r22
  local __body12 = cut(____id16, 0)
  return join({"let", {__x83, __v2}}, __body12, {__x83})
end})
setenv("let-when", {_stash = true, macro = function (x, v, ...)
  local ____r23 = unstash({...})
  local __x88 = destash33(x, ____r23)
  local __v3 = destash33(v, ____r23)
  local ____id17 = ____r23
  local __body13 = cut(____id17, 0)
  local __y = unique("y")
...
setenv("define-transformer", {_stash = true, macro = function (name, form, ...)
  ...
  local __name1 = destash33(name, ____r24)
  local __form1 = destash33(form, ____r24)
  local ____id18 = ____r24
  local __body14 = cut(____id18, 0)
  local ____x95 = {"setenv", {"quote", __name1}}
  ____x95.transformer = join({"fn", {__form1}}, __body14)
  return join(____x95, props(__body14))
end})
setenv("define-macro", {_stash = true, macro = function (name, args, ...)
  local ____r25 = unstash({...})
  local __name2 = destash33(name, ____r25)
  local __args1 = destash33(args, ____r25)
  local ____id19 = ____r25
  local __body15 = cut(____id19, 0)
  local ____x100 = {"setenv", {"quote", __name2}}
...
setenv("define-special", {_stash = true, macro = function (name, args, ...)
  ...
  local __args2 = destash33(args, ____r26)
  local ____id20 = ____r26
  local __body16 = cut(____id20, 0)
  local ____x104 = {"setenv", {"quote", __name3}}
  ____x104.special = join({"fn", __args2}, __body16)
  return join(____x104, props(__body16))
end})
setenv("define-symbol", {_stash = true, macro = function (name, expansion)
  local ____x107 = {"setenv", {"quote", name}}
  ____x107.symbol = {"quote", expansion}
  return ____x107
end})
setenv("define-reader", {_stash = true, macro = function (__x110, ...)
  local ____id21 = __x110
  local __char = ____id21[1]
  local __s = ____id21[2]
  local ____r28 = unstash({...})
  local ____x110 = destash33(__x110, ____r28)
  local ____id22 = ____r28
  local __body17 = cut(____id22, 0)
  return {"set", {"get", "read-table", __char}, join({"fn", {__s}}, __body17)}
end})
setenv("define", {_stash = true, macro = function (name, x, ...)
  local ____r29 = unstash({...})
  local __name4 = destash33(name, ____r29)
  local __x117 = destash33(x, ____r29)
  local ____id23 = ____r29
  local __body18 = cut(____id23, 0)
...
setenv("define-global", {_stash = true, macro = function (name, x, ...)
  ...
  local __name5 = destash33(name, ____r30)
  local __x121 = destash33(x, ____r30)
  local ____id24 = ____r30
  local __body19 = cut(____id24, 0)
...
setenv("with-bindings", {_stash = true, macro = function (__x135, ...)
  local ____id25 = __x135
  local __names = ____id25[1]
  local ____r31 = unstash({...})
  local ____x135 = destash33(__x135, ____r31)
  local ____id26 = ____r31
  local __body21 = cut(____id26, 0)
  local __x137 = unique("x")
  local ____x140 = {"setenv", __x137}
...
setenv("let-macro", {_stash = true, macro = function (definitions, ...)
  ...
  local ____id27 = ____r32
  local __body22 = cut(____id27, 0)
  add(_G.environment, {})
  local ____x143 = __definitions
  local ____i1 = 0
  while ____i1 < _35(____x143) do
    local __m = ____x143[____i1 + 1]
    eval(join({"define-macro"}, __m))
    ____i1 = ____i1 + 1
  end
  local ____x142 = join({"%do"}, macroexpand(__body22))
  drop(_G.environment)
  return ____x142
end})
setenv("let-symbol", {_stash = true, macro = function (expansions, ...)
  ...
  local ____id28 = ____r33
  local __body23 = cut(____id28, 0)
  add(_G.environment, {})
  local ____x148 = pair(__expansions)
  local ____i2 = 0
  while ____i2 < _35(____x148) do
    local ____id29 = ____x148[____i2 + 1]
    local __name6 = ____id29[1]
    local __exp = ____id29[2]
    eval({"define-symbol", __name6, __exp})
    ____i2 = ____i2 + 1
  end
  local ____x147 = join({"%do"}, macroexpand(__body23))
  drop(_G.environment)
  return ____x147
end})
setenv("let-unique", {_stash = true, macro = function (names, ...)
  ...
  local ____id30 = ____r34
  local __body24 = cut(____id30, 0)
...
setenv("fn", {_stash = true, macro = function (args, ...)
  ...
  local __args3 = destash33(args, ____r36)
  local ____id31 = ____r36
  local __body25 = cut(____id31, 0)
...
setenv("apply", {_stash = true, macro = function (f, ...)
  ...
  local ____id32 = ____r37
  local __args4 = cut(____id32, 0)
...
setenv("each", {_stash = true, macro = function (x, t, ...)
  ...
  local ____id34 = __e1
  local __k1 = ____id34[1]
  local __v4 = ____id34[2]
...
setenv("for", {_stash = true, macro = function (i, to, ...)
  ...
  local ____id35 = ____r40
  local __body27 = cut(____id35, 0)
  if obj63(__i4) then
...
setenv("step", {_stash = true, macro = function (v, t, ...)
  ...
  local ____id36 = ____r42
  local __body28 = cut(____id36, 0)
...
setenv("join!", {_stash = true, macro = function (a, ...)
  ...
  local ____id37 = ____r44
  local __bs3 = cut(____id37, 0)
  return {"set", __a1, join({"join", __a1}, __bs3)}
end})
setenv("cat!", {_stash = true, macro = function (a, ...)
  local ____r45 = unstash({...})
  local __a2 = destash33(a, ____r45)
  local ____id38 = ____r45
  local __bs4 = cut(____id38, 0)
...
setenv("compose", {_stash = true, transformer = function (__x258)
  ...
  local __compose = ____id40[1]
  local __fns = cut(____id40, 1)
  local __body31 = cut(____id39, 1)
...
setenv("complement", {_stash = true, transformer = function (__x263)
  ...
  local __complement = ____id42[1]
  local __form3 = ____id42[2]
  local __body32 = cut(____id41, 1)
  if hd63(__form3, "complement") then
    return macroexpand(join({__form3[2]}, __body32))
  else
    return macroexpand({"no", join({__form3}, __body32)})
  end
end})
setenv("expansion", {_stash = true, transformer = function (__x267)
  local ____id43 = __x267
  local ____id44 = ____id43[1]
  local __expansion = ____id44[1]
  local __form4 = ____id43[2]
  return __form4
end})
setenv("hd", {_stash = true, expander = function (setfn, ...)
  local ____r56 = unstash({...})
  local __setfn1 = destash33(setfn, ____r56)
  local ____id46 = ____r56
