  ...
  if nil63(__form) then
    ...
    if special_form63(__form) then
      ...
      if atom63(__form) then
        __e27 = compile_atom(__form, either(__esc63, true))
      else
        local __e28 = nil
...
setenv("%names", {_stash = true, special = function (...)
  ...
  if one63(__args8) then
    ...
    local __s4 = __e37
    local __c6 = ""
    local ____x133 = __args8
    local ____i21 = 0
    while ____i21 < _35(____x133) do
      local __x134 = ____x133[____i21 + 1]
      __s4 = __s4 .. __c6 .. compile(__x134)
      __c6 = ", "
      ____i21 = ____i21 + 1
    end
    local __e38 = nil
...
setenv("%global-function", {_stash = true, special = function (name, args, body)
  if _G.target == "lua" then
    local __x140 = compile_function(args, body, {_stash = true, name = name, global = true})
...
setenv("%local-function", {_stash = true, special = function (name, args, body)
  if _G.target == "lua" then
    local __x143 = compile_function(args, body, {_stash = true, name = name, prefix = "local"})
